...
def sound_event_detection(args):
    ...
    axs[1].xaxis.set_ticklabels(x_labels[:len(x_ticks)], rotation=90)
    ...
    def marker_position(t):
        left_margin = 0.1
        plot_width = 0.8
        x_start = left_margin * static_eventogram_clip.w
        x_pos = x_start + (plot_width * static_eventogram_clip.w / duration) * t
        return (x_pos, 0)
