...
def sound_event_detection(args):
    ...
    if args.dynamic_eventogram:
        ...
        def make_frame(t):
            ...
            # Adjust for edges
            if current_frame < half_window_frames:
                end_frame = min(window_frames, frames_num)
            if current_frame > frames_num - half_window_frames:
                start_frame = max(0, frames_num - window_frames)
