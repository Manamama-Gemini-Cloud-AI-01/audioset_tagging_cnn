...
if __name__ == '__main__':
    print(f"Eventogrammer, version 6.0.14. Recently changed: * idempotency * Conversion to MP3, if no input media duration detected * Conversion to aac audio codec, always")
